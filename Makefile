...
bin/test_neuralnet: bin/test_obj/test.o bin/test_obj/test_utils.o bin/test_obj/test_file_array.o bin/test_obj/test_adj_matrix.o bin/test_obj/test_math_utils.o bin/test_obj/test_timer.o bin/test_obj/neuron.o bin/test_obj/file_array.o bin/test_obj/adj_matrix.o bin/test_obj/math_utils.o bin/test_obj/timer.o
	$(CC) $(CFLAGS) -o bin/test_neuralnet bin/test_obj/test.o bin/test_obj/test_utils.o bin/test_obj/test_file_array.o bin/test_obj/test_adj_matrix.o bin/test_obj/test_math_utils.o bin/test_obj/test_timer.o bin/test_obj/neuron.o bin/test_obj/file_array.o bin/test_obj/adj_matrix.o bin/test_obj/math_utils.o bin/test_obj/timer.o $(LDFLAGS)
