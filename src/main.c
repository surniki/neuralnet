...
struct neuron_profile tonic_profile = {
	...
	.V_leak = -60.0,  /* checked */
	.rho = 0.607,     /* checked */
	.g_Na = 0.7,      /* checked, changed from 1.5 -> 1.0 */
	.V_Na = 50.0,     /* checked */
	.g_K = 2.0,       /* checked */
	.V_K = -90.0,     /* checked */
	.g_sd = 0.25,     /* checked */
...
int main(void)
{
	...
	while ((sim_time = neural_network_get_time(ns)) < transient_time) {
